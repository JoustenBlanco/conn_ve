                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text('Nombre', style: AppTextStyles.subtitle.copyWith(color: AppColors.purpleAccent)),
                                const SizedBox(height: 2),
                                Text(nombre ?? '', style: AppTextStyles.title.copyWith(fontSize: 20, color: AppColors.textColor)),
                                const SizedBox(height: 18),
                                Text('Correo', style: AppTextStyles.subtitle.copyWith(color: AppColors.purpleAccent)),
                                const SizedBox(height: 2),
                                Text(correo ?? '', style: AppTextStyles.title.copyWith(fontSize: 18, color: AppColors.purpleAccent)),
                                const SizedBox(height: 18),
                                Text('Contraseña', style: AppTextStyles.subtitle.copyWith(color: AppColors.purpleAccent)),
                                const SizedBox(height: 2),
                                Row(
                                  children: [
                                    Text('********', style: AppTextStyles.title.copyWith(fontSize: 18, color: AppColors.textColor)),
